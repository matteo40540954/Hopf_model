...
1) defined a control baseline: we used real  MRI data to find the optimal bifurcation parameter that best describes healthy poplulation using an evolutionary algorithm (we selected a= 0.175).  
2) localized simulation of visual cortex:choose the optimal bifurcation parameter that best describes patients visual areas (we selected a=0.453).  
